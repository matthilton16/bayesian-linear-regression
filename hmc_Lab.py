...
warnings.filterwarnings('ignore', message='divide by zero encountered in log', category=RuntimeWarning) # Add this
warnings.filterwarnings('ignore', message='invalid value encountered in multiply', category=RuntimeWarning) # Add this
warnings.filterwarnings('ignore', message='invalid value encountered in log', category=RuntimeWarning) # Add this
